...
function addSubjectRow() {
    ...
    newRow.innerHTML = `
        ...
        <input type="number" name="total_marks_dyn" min="0" required placeholder="Total" class="mt-1 block w-1D/4 rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm">
